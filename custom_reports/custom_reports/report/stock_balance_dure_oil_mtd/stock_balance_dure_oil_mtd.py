...
def execute(filters=None):
	...
	filters.update({'from_date': str(first_day_month), 'to_date': to_date,'item_code':'wo001','company':'Dure Oil Middle East Factory - Sole Proprietorship LLC','warehouse':['FT-1/FT-2 (WASTE OIL) - DURE','RT (WASTE OIL) - DURE']})
