...
def execute(filters=None):
	...
	filters.update({'from_date': str(first_day_year), 'to_date': to_date,'item_code':'wo005','company':'Dure Oil Middle East Factory - Sole Proprietorship LLC','warehouse':['WASTE OIL(EXTERNAL TANK) - DURE']})
