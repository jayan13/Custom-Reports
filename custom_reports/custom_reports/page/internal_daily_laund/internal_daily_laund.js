...
frappe.pages['internal-daily-laund'].on_page_load = function(wrapper) {
	new MyPage(wrapper);
}
		...
		MyPage =Class.extend({
			...
			make: function()
			{
				...
				frappe.call({
				  method: 'custom_reports.custom_reports.page.internal_daily_laund.internal_daily_laund.get_customer_list',
				  args: {},
				  callback: function (r) {
					if (r.message) {
				...
				function get_report()
				{
					...
					{		
							frappe.call({
							method: 'custom_reports.custom_reports.page.internal_daily_laund.internal_daily_laund.get_report',
							freeze: 1,
