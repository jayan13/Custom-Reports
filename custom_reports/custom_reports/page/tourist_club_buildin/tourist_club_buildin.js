...
frappe.pages['tourist-club-buildin'].on_page_load = function(wrapper) {
	new MyPage(wrapper);
}
		...
		MyPage =Class.extend({
			...
			make: function()
			{
				...
				frappe.call({
					method: 'custom_reports.custom_reports.page.tourist_club_buildin.tourist_club_buildin.get_report',
					freeze: 1,
