...
frappe.pages['al-zayani-occupied'].on_page_load = function(wrapper) {
	new MyPage(wrapper);
}
		...
		MyPage =Class.extend({
			...
			make: function()
			{
				...
				frappe.call({
					method: 'custom_reports.custom_reports.page.al_zayani_occupied.al_zayani_occupied.get_report',
					freeze: 1,
