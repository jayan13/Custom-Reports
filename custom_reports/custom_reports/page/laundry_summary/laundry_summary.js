...
frappe.pages['laundry-summary'].on_page_load = function(wrapper) {
	new MyPage(wrapper);
}
		...
		MyPage =Class.extend({
			...
			make: function()
			{
				...
				frappe.call({
				  method: 'custom_reports.custom_reports.page.laundry_summary.laundry_summary.get_customer_list',
				  args: {},
				  callback: function (r) {
					if (r.message) {
				...
				function get_report()
				{
					...
					{		
							frappe.call({
							method: 'custom_reports.custom_reports.page.laundry_summary.laundry_summary.get_report',
							freeze: 1,
