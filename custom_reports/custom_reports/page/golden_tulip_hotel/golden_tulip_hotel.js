...
frappe.pages['golden-tulip-hotel'].on_page_load = function(wrapper) {
	new MyPage(wrapper);
}
		...
		MyPage =Class.extend({
			...
			make: function()
			{
				...
				frappe.call({
					method: 'custom_reports.custom_reports.page.golden_tulip_hotel.golden_tulip_hotel.get_report',
					freeze: 1,
