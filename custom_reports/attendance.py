...
class AttendanceCustom(Attendance):
	def validate(self):
		from erpnext.controllers.status_updater import validate_status

		validate_status(self.status, ["Present", "Absent", "On Leave", "Half Day", "Work From Home","Annual Leave"])
	...
	def check_leave_record(self):
		...
		if self.status in ("On Leave", "Half Day"):
			if not leave_record and not self.shift_roster:
				frappe.msgprint(
